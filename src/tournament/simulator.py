...
ALL_ELOS: dict[str, int] = {
    'ARG': 2324, 'BRA': 2097, 'FRA': 2224, 'ENG': 2102, 'ESP': 1960, 'GER': 2001,
    'POR': 1877, 'NED': 2111, 'URU': 1764, 'USA': 2070, 'MAR': 2106, 'BEL': 1851,
    'CRO': 1778, 'SUI': 1990, 'AUT': 1898, 'TUR': 1551, 'SCO': 1702, 'COL': 2107,
    'ECU': 1698, 'PAR': 1807, 'JPN': 2007, 'KOR': 1674, 'KSA': 1662, 'AUS': 1812,
    'IRN': 1762, 'QAT': 1576, 'IRQ': 1507, 'UZB': 1468, 'SEN': 1635, 'EGY': 1949,
    'CIV': 1870, 'ALG': 1794, 'RSA': 1731, 'TUN': 1403, 'MEX': 2209, 'CAN': 1790,
    'PAN': 1373, 'NZL': 1653,
    # New WC2026 teams
    'SWE': 1841, 'NOR': 2074, 'CZE': 1532, 'GHA': 2011, 'COD': 1787,
    'BIH': 1773, 'CPV': 1848, 'JOR': 1395, 'CUW': 1524, 'HAI': 1335,
}
