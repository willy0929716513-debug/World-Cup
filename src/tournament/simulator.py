...
ALL_ELOS: dict[str, int] = {
    'ARG': 2446, 'BRA': 2234, 'FRA': 2506, 'ENG': 2174, 'ESP': 2088, 'GER': 1830,
    'POR': 2085, 'NED': 2139, 'URU': 1718, 'USA': 1975, 'MAR': 2229, 'BEL': 1939,
    'CRO': 1903, 'SUI': 2097, 'AUT': 1768, 'TUR': 1760, 'SCO': 1668, 'COL': 2161,
    'ECU': 1750, 'PAR': 1840, 'JPN': 1939, 'KOR': 1536, 'KSA': 1717, 'AUS': 1855,
    'IRN': 1818, 'QAT': 1570, 'IRQ': 1268, 'UZB': 1306, 'SEN': 1642, 'EGY': 1897,
    'CIV': 1810, 'ALG': 1771, 'RSA': 1616, 'TUN': 1290, 'MEX': 2308, 'CAN': 1850,
    'PAN': 1260, 'NZL': 1589,
    # New WC2026 teams
    'SWE': 1851, 'NOR': 2198, 'CZE': 1425, 'GHA': 1806, 'COD': 1831,
    'BIH': 1759, 'CPV': 1808, 'JOR': 1253, 'CUW': 1523, 'HAI': 1203,
}
