...
ALL_ELOS: dict[str, int] = {
    'ARG': 2303, 'BRA': 2075, 'FRA': 2203, 'ENG': 2106, 'ESP': 1960, 'GER': 2103,
    'POR': 1884, 'NED': 2101, 'URU': 1764, 'USA': 2185, 'MAR': 2090, 'BEL': 1851,
    'CRO': 1786, 'SUI': 1971, 'AUT': 1902, 'TUR': 1437, 'SCO': 1717, 'COL': 2078,
    'ECU': 1611, 'PAR': 1803, 'JPN': 2025, 'KOR': 1721, 'KSA': 1666, 'AUS': 1816,
    'IRN': 1766, 'QAT': 1596, 'IRQ': 1531, 'UZB': 1488, 'SEN': 1636, 'EGY': 1945,
    'CIV': 1852, 'ALG': 1786, 'RSA': 1697, 'TUN': 1424, 'MEX': 2187, 'CAN': 1801,
    'PAN': 1393, 'NZL': 1653,
    # New WC2026 teams
    'SWE': 1812, 'NOR': 2070, 'CZE': 1541, 'GHA': 1981, 'COD': 1791,
    'BIH': 1761, 'CPV': 1844, 'JOR': 1420, 'CUW': 1526, 'HAI': 1357,
}
