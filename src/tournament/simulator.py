...
ALL_ELOS: dict[str, int] = {
    'ARG': 2414, 'BRA': 2239, 'FRA': 2429, 'ENG': 2139, 'ESP': 2043, 'GER': 1854,
    'POR': 1984, 'NED': 2125, 'URU': 1708, 'USA': 1935, 'MAR': 2191, 'BEL': 1904,
    'CRO': 1971, 'SUI': 2041, 'AUT': 1833, 'TUR': 1732, 'SCO': 1668, 'COL': 2092,
    'ECU': 1772, 'PAR': 1813, 'JPN': 1945, 'KOR': 1579, 'KSA': 1706, 'AUS': 1815,
    'IRN': 1813, 'QAT': 1568, 'IRQ': 1315, 'UZB': 1343, 'SEN': 1686, 'EGY': 1907,
    'CIV': 1826, 'ALG': 1847, 'RSA': 1649, 'TUN': 1323, 'MEX': 2303, 'CAN': 1864,
    'PAN': 1293, 'NZL': 1589,
    # New WC2026 teams
    'SWE': 1864, 'NOR': 2104, 'CZE': 1467, 'GHA': 1868, 'COD': 1812,
    'BIH': 1767, 'CPV': 1800, 'JOR': 1296, 'CUW': 1544, 'HAI': 1236,
}
