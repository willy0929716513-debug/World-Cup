...
ALL_ELOS: dict[str, int] = {
    'ARG': 2365, 'BRA': 2132, 'FRA': 2320, 'ENG': 2106, 'ESP': 2010, 'GER': 1896,
    'POR': 1909, 'NED': 2126, 'URU': 1717, 'USA': 1930, 'MAR': 2134, 'BEL': 1893,
    'CRO': 1893, 'SUI': 2009, 'AUT': 1874, 'TUR': 1690, 'SCO': 1681, 'COL': 2112,
    'ECU': 1777, 'PAR': 1808, 'JPN': 2000, 'KOR': 1631, 'KSA': 1702, 'AUS': 1812,
    'IRN': 1803, 'QAT': 1556, 'IRQ': 1404, 'UZB': 1415, 'SEN': 1677, 'EGY': 1912,
    'CIV': 1879, 'ALG': 1823, 'RSA': 1752, 'TUN': 1365, 'MEX': 2249, 'CAN': 1784,
    'PAN': 1335, 'NZL': 1606,
    # New WC2026 teams
    'SWE': 1872, 'NOR': 2037, 'CZE': 1514, 'GHA': 1929, 'COD': 1804,
    'BIH': 1780, 'CPV': 1807, 'JOR': 1348, 'CUW': 1541, 'HAI': 1290,
}
