...
ALL_ELOS: dict[str, int] = {
    'ARG': 2265, 'BRA': 2027, 'FRA': 2187, 'ENG': 2130, 'ESP': 1960, 'GER': 2183,
    'POR': 1888, 'NED': 2079, 'URU': 1764, 'USA': 2180, 'MAR': 2066, 'BEL': 1852,
    'CRO': 1793, 'SUI': 1908, 'AUT': 1911, 'TUR': 1444, 'SCO': 1754, 'COL': 2019,
    'ECU': 1526, 'PAR': 1802, 'JPN': 2022, 'KOR': 1841, 'KSA': 1675, 'AUS': 1817,
    'IRN': 1772, 'QAT': 1660, 'IRQ': 1549, 'UZB': 1523, 'SEN': 1668, 'EGY': 1932,
    'CIV': 1828, 'ALG': 1766, 'RSA': 1594, 'TUN': 1461, 'MEX': 2142, 'CAN': 1856,
    'PAN': 1429, 'NZL': 1654,
    # New WC2026 teams
    'SWE': 1799, 'NOR': 2037, 'CZE': 1567, 'GHA': 1913, 'COD': 1810,
    'BIH': 1704, 'CPV': 1832, 'JOR': 1467, 'CUW': 1554, 'HAI': 1393,
}
