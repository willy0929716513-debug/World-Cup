...
ALL_ELOS: dict[str, int] = {
    'ARG': 2173, 'BRA': 2028, 'FRA': 2172, 'ENG': 2155, 'ESP': 1906, 'GER': 2122,
    'POR': 1900, 'NED': 2010, 'URU': 1868, 'USA': 2239, 'MAR': 2092, 'BEL': 1880,
    'CRO': 1762, 'SUI': 1942, 'AUT': 2047, 'TUR': 1485, 'SCO': 1859, 'COL': 2060,
    'ECU': 1568, 'PAR': 1765, 'JPN': 1929, 'KOR': 1933, 'KSA': 1860, 'AUS': 1928,
    'IRN': 1788, 'QAT': 1747, 'IRQ': 1622, 'UZB': 1667, 'SEN': 1721, 'EGY': 1873,
    'CIV': 1739, 'ALG': 1715, 'RSA': 1621, 'TUN': 1610, 'MEX': 2223, 'CAN': 1945,
    'PAN': 1607, 'NZL': 1780,
    # New WC2026 teams
    'SWE': 1986, 'NOR': 2050, 'CZE': 1602, 'GHA': 1985, 'COD': 1888,
    'BIH': 1751, 'CPV': 1897, 'JOR': 1626, 'CUW': 1614, 'HAI': 1496,
}
