...
ALL_ELOS: dict[str, int] = {
    'ARG': 2251, 'BRA': 2021, 'FRA': 2181, 'ENG': 2145, 'ESP': 1960, 'GER': 2171,
    'POR': 1886, 'NED': 2071, 'URU': 1766, 'USA': 2162, 'MAR': 2058, 'BEL': 1854,
    'CRO': 1793, 'SUI': 1889, 'AUT': 1915, 'TUR': 1463, 'SCO': 1757, 'COL': 1992,
    'ECU': 1535, 'PAR': 1800, 'JPN': 2012, 'KOR': 1839, 'KSA': 1679, 'AUS': 1817,
    'IRN': 1774, 'QAT': 1680, 'IRQ': 1556, 'UZB': 1537, 'SEN': 1681, 'EGY': 1926,
    'CIV': 1826, 'ALG': 1757, 'RSA': 1601, 'TUN': 1475, 'MEX': 2125, 'CAN': 1873,
    'PAN': 1444, 'NZL': 1656,
    # New WC2026 teams
    'SWE': 1803, 'NOR': 2023, 'CZE': 1578, 'GHA': 1882, 'COD': 1824,
    'BIH': 1685, 'CPV': 1826, 'JOR': 1486, 'CUW': 1560, 'HAI': 1405,
}
