...
ALL_ELOS: dict[str, int] = {
    'ARG': 2437, 'BRA': 2274, 'FRA': 2485, 'ENG': 2147, 'ESP': 2082, 'GER': 1835,
    'POR': 2069, 'NED': 2133, 'URU': 1715, 'USA': 1966, 'MAR': 2219, 'BEL': 1930,
    'CRO': 1911, 'SUI': 2091, 'AUT': 1782, 'TUR': 1751, 'SCO': 1668, 'COL': 2144,
    'ECU': 1756, 'PAR': 1834, 'JPN': 1939, 'KOR': 1547, 'KSA': 1714, 'AUS': 1845,
    'IRN': 1815, 'QAT': 1570, 'IRQ': 1280, 'UZB': 1315, 'SEN': 1657, 'EGY': 1896,
    'CIV': 1814, 'ALG': 1786, 'RSA': 1625, 'TUN': 1299, 'MEX': 2329, 'CAN': 1857,
    'PAN': 1269, 'NZL': 1589,
    # New WC2026 teams
    'SWE': 1852, 'NOR': 2138, 'CZE': 1435, 'GHA': 1820, 'COD': 1822,
    'BIH': 1758, 'CPV': 1805, 'JOR': 1265, 'CUW': 1529, 'HAI': 1212,
}
