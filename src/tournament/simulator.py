...
ALL_ELOS: dict[str, int] = {
    ...
    'CRO': 1925, 'SUI': 1895, 'AUT': 1905, 'TUR': 1870, 'SCO': 1855, 'COL': 1932,
    'ECU': 1855, 'PAR': 1820, 'JPN': 1870, 'KOR': 1840, 'KSA': 1800, 'AUS': 1820,
    'IRN': 1820, 'QAT': 1765, 'IRQ': 1780, 'UZB': 1795, 'SEN': 1855, 'EGY': 1815,
    'CIV': 1820, 'ALG': 1825, 'RSA': 1785, 'TUN': 1795, 'MEX': 1878, 'CAN': 1902,
    'PAN': 1772, 'NZL': 1748,
    # New WC2026 teams
    'SWE': 1905, 'NOR': 1892, 'CZE': 1872, 'GHA': 1820, 'COD': 1810,
    'BIH': 1825, 'CPV': 1788, 'JOR': 1768, 'CUW': 1749, 'HAI': 1718,
}
