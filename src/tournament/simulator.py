...
ALL_ELOS: dict[str, int] = {
    'ARG': 2167, 'BRA': 2016, 'FRA': 2166, 'ENG': 2147, 'ESP': 1908, 'GER': 2110,
    'POR': 1902, 'NED': 1973, 'URU': 1868, 'USA': 2221, 'MAR': 2081, 'BEL': 1880,
    'CRO': 1770, 'SUI': 1940, 'AUT': 2041, 'TUR': 1506, 'SCO': 1869, 'COL': 2052,
    'ECU': 1587, 'PAR': 1755, 'JPN': 1916, 'KOR': 1937, 'KSA': 1860, 'AUS': 1934,
    'IRN': 1788, 'QAT': 1749, 'IRQ': 1628, 'UZB': 1675, 'SEN': 1727, 'EGY': 1873,
    'CIV': 1722, 'ALG': 1721, 'RSA': 1626, 'TUN': 1624, 'MEX': 2206, 'CAN': 1943,
    'PAN': 1615, 'NZL': 1780,
    # New WC2026 teams
    'SWE': 2023, 'NOR': 2044, 'CZE': 1610, 'GHA': 1977, 'COD': 1886,
    'BIH': 1753, 'CPV': 1895, 'JOR': 1632, 'CUW': 1624, 'HAI': 1508,
}
