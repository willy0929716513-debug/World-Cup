...
ALL_ELOS: dict[str, int] = {
    'ARG': 2115, 'BRA': 1959, 'FRA': 2112, 'ENG': 2058, 'ESP': 1937, 'GER': 2065,
    'POR': 1936, 'NED': 1926, 'URU': 1879, 'USA': 2040, 'MAR': 1941, 'BEL': 1896,
    'CRO': 1859, 'SUI': 1861, 'AUT': 1971, 'TUR': 1684, 'SCO': 1971, 'COL': 1965,
    'ECU': 1683, 'PAR': 1685, 'JPN': 1909, 'KOR': 2018, 'KSA': 1849, 'AUS': 2006,
    'IRN': 1793, 'QAT': 1820, 'IRQ': 1693, 'UZB': 1762, 'SEN': 1781, 'EGY': 1857,
    'CIV': 1992, 'ALG': 1773, 'RSA': 1656, 'TUN': 1674, 'MEX': 2011, 'CAN': 1869,
    'PAN': 1714, 'NZL': 1775,
    # New WC2026 teams
    'SWE': 2026, 'NOR': 1979, 'CZE': 1690, 'GHA': 1878, 'COD': 1852,
    'BIH': 1837, 'CPV': 1866, 'JOR': 1702, 'CUW': 1665, 'HAI': 1602,
}
