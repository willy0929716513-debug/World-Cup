...
ALL_ELOS: dict[str, int] = {
    'ARG': 2393, 'BRA': 2190, 'FRA': 2372, 'ENG': 2107, 'ESP': 2020, 'GER': 1875,
    'POR': 1947, 'NED': 2131, 'URU': 1709, 'USA': 1900, 'MAR': 2157, 'BEL': 1903,
    'CRO': 1964, 'SUI': 2023, 'AUT': 1859, 'TUR': 1720, 'SCO': 1671, 'COL': 2094,
    'ECU': 1789, 'PAR': 1808, 'JPN': 1966, 'KOR': 1608, 'KSA': 1705, 'AUS': 1812,
    'IRN': 1812, 'QAT': 1557, 'IRQ': 1353, 'UZB': 1374, 'SEN': 1682, 'EGY': 1907,
    'CIV': 1858, 'ALG': 1841, 'RSA': 1682, 'TUN': 1344, 'MEX': 2273, 'CAN': 1847,
    'PAN': 1314, 'NZL': 1594,
    # New WC2026 teams
    'SWE': 1878, 'NOR': 2056, 'CZE': 1495, 'GHA': 1877, 'COD': 1825,
    'BIH': 1791, 'CPV': 1800, 'JOR': 1320, 'CUW': 1549, 'HAI': 1262,
}
