...
ALL_ELOS: dict[str, int] = {
    'ARG': 2381, 'BRA': 2156, 'FRA': 2350, 'ENG': 2106, 'ESP': 2017, 'GER': 1881,
    'POR': 1934, 'NED': 2130, 'URU': 1712, 'USA': 1908, 'MAR': 2146, 'BEL': 1900,
    'CRO': 1943, 'SUI': 2015, 'AUT': 1864, 'TUR': 1712, 'SCO': 1674, 'COL': 2099,
    'ECU': 1787, 'PAR': 1808, 'JPN': 1988, 'KOR': 1620, 'KSA': 1705, 'AUS': 1812,
    'IRN': 1809, 'QAT': 1554, 'IRQ': 1373, 'UZB': 1390, 'SEN': 1682, 'EGY': 1908,
    'CIV': 1879, 'ALG': 1835, 'RSA': 1707, 'TUN': 1353, 'MEX': 2264, 'CAN': 1827,
    'PAN': 1323, 'NZL': 1597,
    # New WC2026 teams
    'SWE': 1879, 'NOR': 2034, 'CZE': 1505, 'GHA': 1892, 'COD': 1817,
    'BIH': 1783, 'CPV': 1802, 'JOR': 1332, 'CUW': 1546, 'HAI': 1274,
}
