...
ALL_ELOS: dict[str, int] = {
    'ARG': 2279, 'BRA': 2046, 'FRA': 2193, 'ENG': 2119, 'ESP': 1960, 'GER': 2195,
    'POR': 1888, 'NED': 2087, 'URU': 1764, 'USA': 2196, 'MAR': 2074, 'BEL': 1851,
    'CRO': 1791, 'SUI': 1936, 'AUT': 1907, 'TUR': 1427, 'SCO': 1739, 'COL': 2042,
    'ECU': 1518, 'PAR': 1802, 'JPN': 2032, 'KOR': 1810, 'KSA': 1671, 'AUS': 1817,
    'IRN': 1770, 'QAT': 1631, 'IRQ': 1543, 'UZB': 1510, 'SEN': 1656, 'EGY': 1937,
    'CIV': 1830, 'ALG': 1774, 'RSA': 1620, 'TUN': 1449, 'MEX': 2159, 'CAN': 1829,
    'PAN': 1416, 'NZL': 1653,
    # New WC2026 teams
    'SWE': 1795, 'NOR': 2049, 'CZE': 1556, 'GHA': 1939, 'COD': 1801,
    'BIH': 1732, 'CPV': 1837, 'JOR': 1450, 'CUW': 1548, 'HAI': 1381,
}
