...
ALL_ELOS: dict[str, int] = {
    'ARG': 2329, 'BRA': 2102, 'FRA': 2238, 'ENG': 2102, 'ESP': 1970, 'GER': 1982,
    'POR': 1875, 'NED': 2113, 'URU': 1754, 'USA': 2046, 'MAR': 2110, 'BEL': 1851,
    'CRO': 1776, 'SUI': 1993, 'AUT': 1897, 'TUR': 1575, 'SCO': 1699, 'COL': 2114,
    'ECU': 1713, 'PAR': 1808, 'JPN': 2005, 'KOR': 1666, 'KSA': 1671, 'AUS': 1812,
    'IRN': 1762, 'QAT': 1572, 'IRQ': 1492, 'UZB': 1463, 'SEN': 1644, 'EGY': 1950,
    'CIV': 1873, 'ALG': 1796, 'RSA': 1736, 'TUN': 1398, 'MEX': 2214, 'CAN': 1788,
    'PAN': 1368, 'NZL': 1653,
    # New WC2026 teams
    'SWE': 1846, 'NOR': 2066, 'CZE': 1530, 'GHA': 2017, 'COD': 1786,
    'BIH': 1775, 'CPV': 1839, 'JOR': 1389, 'CUW': 1525, 'HAI': 1330,
}
