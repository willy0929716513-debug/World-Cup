...
ALL_ELOS: dict[str, int] = {
    'ARG': 2598, 'BRA': 2142, 'FRA': 2434, 'ENG': 2385, 'ESP': 2493, 'GER': 1814,
    'POR': 2071, 'NED': 2125, 'URU': 1792, 'USA': 1900, 'MAR': 2163, 'BEL': 2037,
    'CRO': 1902, 'SUI': 2101, 'AUT': 1752, 'TUR': 1754, 'SCO': 1640, 'COL': 2160,
    'ECU': 1719, 'PAR': 1827, 'JPN': 1908, 'KOR': 1475, 'KSA': 1791, 'AUS': 1854,
    'IRN': 1865, 'QAT': 1560, 'IRQ': 1208, 'UZB': 1271, 'SEN': 1621, 'EGY': 1929,
    'CIV': 1804, 'ALG': 1731, 'RSA': 1561, 'TUN': 1251, 'MEX': 2116, 'CAN': 1822,
    'PAN': 1222, 'NZL': 1628,
    # New WC2026 teams
    'SWE': 1836, 'NOR': 2245, 'CZE': 1364, 'GHA': 1796, 'COD': 1867,
    'BIH': 1737, 'CPV': 1889, 'JOR': 1197, 'CUW': 1505, 'HAI': 1158,
}
