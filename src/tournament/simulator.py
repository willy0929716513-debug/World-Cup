...
ALL_ELOS: dict[str, int] = {
    'ARG': 2297, 'BRA': 2069, 'FRA': 2201, 'ENG': 2108, 'ESP': 1960, 'GER': 2134,
    'POR': 1885, 'NED': 2097, 'URU': 1764, 'USA': 2218, 'MAR': 2086, 'BEL': 1851,
    'CRO': 1788, 'SUI': 1964, 'AUT': 1903, 'TUR': 1404, 'SCO': 1722, 'COL': 2070,
    'ECU': 1582, 'PAR': 1802, 'JPN': 2032, 'KOR': 1738, 'KSA': 1667, 'AUS': 1817,
    'IRN': 1767, 'QAT': 1603, 'IRQ': 1534, 'UZB': 1493, 'SEN': 1641, 'EGY': 1943,
    'CIV': 1846, 'ALG': 1783, 'RSA': 1683, 'TUN': 1430, 'MEX': 2181, 'CAN': 1806,
    'PAN': 1398, 'NZL': 1653,
    # New WC2026 teams
    'SWE': 1802, 'NOR': 2065, 'CZE': 1544, 'GHA': 1972, 'COD': 1793,
    'BIH': 1756, 'CPV': 1843, 'JOR': 1427, 'CUW': 1530, 'HAI': 1363,
}
