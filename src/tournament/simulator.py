...
ALL_ELOS: dict[str, int] = {
    'ARG': 2291, 'BRA': 2062, 'FRA': 2199, 'ENG': 2111, 'ESP': 1960, 'GER': 2166,
    'POR': 1886, 'NED': 2093, 'URU': 1764, 'USA': 2211, 'MAR': 2082, 'BEL': 1851,
    'CRO': 1789, 'SUI': 1956, 'AUT': 1904, 'TUR': 1411, 'SCO': 1727, 'COL': 2061,
    'ECU': 1550, 'PAR': 1802, 'JPN': 2040, 'KOR': 1758, 'KSA': 1668, 'AUS': 1817,
    'IRN': 1768, 'QAT': 1611, 'IRQ': 1537, 'UZB': 1498, 'SEN': 1646, 'EGY': 1941,
    'CIV': 1839, 'ALG': 1780, 'RSA': 1666, 'TUN': 1437, 'MEX': 2174, 'CAN': 1812,
    'PAN': 1404, 'NZL': 1653,
    # New WC2026 teams
    'SWE': 1791, 'NOR': 2060, 'CZE': 1547, 'GHA': 1962, 'COD': 1795,
    'BIH': 1750, 'CPV': 1841, 'JOR': 1434, 'CUW': 1536, 'HAI': 1369,
}
