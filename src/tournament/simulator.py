...
ALL_ELOS: dict[str, int] = {
    'ARG': 2353, 'BRA': 2122, 'FRA': 2294, 'ENG': 2106, 'ESP': 2000, 'GER': 1917,
    'POR': 1882, 'NED': 2123, 'URU': 1724, 'USA': 1960, 'MAR': 2125, 'BEL': 1884,
    'CRO': 1829, 'SUI': 2005, 'AUT': 1887, 'TUR': 1660, 'SCO': 1687, 'COL': 2130,
    'ECU': 1762, 'PAR': 1808, 'JPN': 2000, 'KOR': 1640, 'KSA': 1696, 'AUS': 1812,
    'IRN': 1794, 'QAT': 1560, 'IRQ': 1432, 'UZB': 1438, 'SEN': 1670, 'EGY': 1919,
    'CIV': 1879, 'ALG': 1809, 'RSA': 1749, 'TUN': 1377, 'MEX': 2237, 'CAN': 1784,
    'PAN': 1346, 'NZL': 1617,
    # New WC2026 teams
    'SWE': 1865, 'NOR': 2044, 'CZE': 1520, 'GHA': 1982, 'COD': 1791,
    'BIH': 1780, 'CPV': 1814, 'JOR': 1363, 'CUW': 1535, 'HAI': 1305,
}
