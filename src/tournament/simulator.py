...
ALL_ELOS: dict[str, int] = {
    'ARG': 2428, 'BRA': 2263, 'FRA': 2464, 'ENG': 2147, 'ESP': 2073, 'GER': 1842,
    'POR': 2048, 'NED': 2124, 'URU': 1712, 'USA': 1957, 'MAR': 2210, 'BEL': 1913,
    'CRO': 1924, 'SUI': 2080, 'AUT': 1798, 'TUR': 1742, 'SCO': 1668, 'COL': 2122,
    'ECU': 1762, 'PAR': 1826, 'JPN': 1940, 'KOR': 1559, 'KSA': 1711, 'AUS': 1830,
    'IRN': 1813, 'QAT': 1569, 'IRQ': 1292, 'UZB': 1324, 'SEN': 1678, 'EGY': 1902,
    'CIV': 1817, 'ALG': 1804, 'RSA': 1634, 'TUN': 1308, 'MEX': 2320, 'CAN': 1864,
    'PAN': 1278, 'NZL': 1589,
    # New WC2026 teams
    'SWE': 1855, 'NOR': 2127, 'CZE': 1447, 'GHA': 1839, 'COD': 1815,
    'BIH': 1758, 'CPV': 1803, 'JOR': 1277, 'CUW': 1535, 'HAI': 1221,
}
