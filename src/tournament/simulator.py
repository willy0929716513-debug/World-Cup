...
ALL_ELOS: dict[str, int] = {
    'ARG': 2272, 'BRA': 2037, 'FRA': 2190, 'ENG': 2124, 'ESP': 1960, 'GER': 2189,
    'POR': 1888, 'NED': 2083, 'URU': 1764, 'USA': 2188, 'MAR': 2070, 'BEL': 1851,
    'CRO': 1792, 'SUI': 1923, 'AUT': 1909, 'TUR': 1435, 'SCO': 1746, 'COL': 2031,
    'ECU': 1522, 'PAR': 1802, 'JPN': 2027, 'KOR': 1842, 'KSA': 1673, 'AUS': 1817,
    'IRN': 1771, 'QAT': 1644, 'IRQ': 1546, 'UZB': 1516, 'SEN': 1662, 'EGY': 1935,
    'CIV': 1829, 'ALG': 1770, 'RSA': 1591, 'TUN': 1455, 'MEX': 2150, 'CAN': 1841,
    'PAN': 1422, 'NZL': 1653,
    # New WC2026 teams
    'SWE': 1797, 'NOR': 2043, 'CZE': 1562, 'GHA': 1927, 'COD': 1805,
    'BIH': 1720, 'CPV': 1835, 'JOR': 1458, 'CUW': 1551, 'HAI': 1387,
}
