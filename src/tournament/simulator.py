...
ALL_ELOS: dict[str, int] = {
    'ARG': 2373, 'BRA': 2138, 'FRA': 2336, 'ENG': 2106, 'ESP': 2014, 'GER': 1887,
    'POR': 1923, 'NED': 2128, 'URU': 1714, 'USA': 1917, 'MAR': 2140, 'BEL': 1897,
    'CRO': 1922, 'SUI': 2011, 'AUT': 1868, 'TUR': 1703, 'SCO': 1677, 'COL': 2104,
    'ECU': 1783, 'PAR': 1808, 'JPN': 2000, 'KOR': 1627, 'KSA': 1704, 'AUS': 1812,
    'IRN': 1807, 'QAT': 1554, 'IRQ': 1388, 'UZB': 1402, 'SEN': 1680, 'EGY': 1910,
    'CIV': 1879, 'ALG': 1830, 'RSA': 1734, 'TUN': 1359, 'MEX': 2257, 'CAN': 1802,
    'PAN': 1329, 'NZL': 1601,
    # New WC2026 teams
    'SWE': 1876, 'NOR': 2035, 'CZE': 1510, 'GHA': 1907, 'COD': 1811,
    'BIH': 1780, 'CPV': 1804, 'JOR': 1340, 'CUW': 1544, 'HAI': 1282,
}
