...
CONFEDERATIONS: dict[str, str] = {
    ...
    'BEL': 'UEFA',     'ITA': 'UEFA',     'CRO': 'UEFA',     'SUI': 'UEFA',
    'AUT': 'UEFA',     'DEN': 'UEFA',     'SRB': 'UEFA',     'TUR': 'UEFA',
    'POL': 'UEFA',     'SCO': 'UEFA',     'MAR': 'CAF',      'SEN': 'CAF',
    'NGA': 'CAF',      'EGY': 'CAF',      'CIV': 'CAF',      'ALG': 'CAF',
    'CMR': 'CAF',      'RSA': 'CAF',      'TUN': 'CAF',      'JPN': 'AFC',
    'KOR': 'AFC',      'KSA': 'AFC',      'AUS': 'AFC',      'IRN': 'AFC',
    'QAT': 'AFC',      'IRQ': 'AFC',      'UZB': 'AFC',      'USA': 'CONCACAF',
    'MEX': 'CONCACAF', 'CAN': 'CONCACAF', 'PAN': 'CONCACAF', 'HON': 'CONCACAF',
    'JAM': 'CONCACAF', 'NZL': 'OFC',      'VEN': 'INT',      'IDN': 'INT',
}
