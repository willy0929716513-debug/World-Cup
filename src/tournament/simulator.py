...
ALL_ELOS: dict[str, int] = {
    'ARG': 2402, 'BRA': 2214, 'FRA': 2397, 'ENG': 2116, 'ESP': 2023, 'GER': 1866,
    'POR': 1956, 'NED': 2129, 'URU': 1708, 'USA': 1895, 'MAR': 2171, 'BEL': 1904,
    'CRO': 1978, 'SUI': 2032, 'AUT': 1856, 'TUR': 1725, 'SCO': 1668, 'COL': 2092,
    'ECU': 1782, 'PAR': 1808, 'JPN': 1954, 'KOR': 1596, 'KSA': 1705, 'AUS': 1812,
    'IRN': 1813, 'QAT': 1563, 'IRQ': 1335, 'UZB': 1359, 'SEN': 1684, 'EGY': 1907,
    'CIV': 1840, 'ALG': 1844, 'RSA': 1665, 'TUN': 1335, 'MEX': 2287, 'CAN': 1858,
    'PAN': 1305, 'NZL': 1591,
    # New WC2026 teams
    'SWE': 1872, 'NOR': 2080, 'CZE': 1483, 'GHA': 1870, 'COD': 1824,
    'BIH': 1800, 'CPV': 1800, 'JOR': 1308, 'CUW': 1548, 'HAI': 1250,
}
