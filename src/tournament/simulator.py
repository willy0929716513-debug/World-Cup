...
ALL_ELOS: dict[str, int] = {
    'ARG': 2452, 'BRA': 2208, 'FRA': 2522, 'ENG': 2218, 'ESP': 2110, 'GER': 1828,
    'POR': 2073, 'NED': 2143, 'URU': 1720, 'USA': 1980, 'MAR': 2230, 'BEL': 1943,
    'CRO': 1902, 'SUI': 2099, 'AUT': 1760, 'TUR': 1766, 'SCO': 1667, 'COL': 2171,
    'ECU': 1746, 'PAR': 1844, 'JPN': 1937, 'KOR': 1529, 'KSA': 1719, 'AUS': 1861,
    'IRN': 1820, 'QAT': 1570, 'IRQ': 1260, 'UZB': 1301, 'SEN': 1634, 'EGY': 1899,
    'CIV': 1810, 'ALG': 1762, 'RSA': 1610, 'TUN': 1284, 'MEX': 2261, 'CAN': 1847,
    'PAN': 1254, 'NZL': 1590,
    # New WC2026 teams
    'SWE': 1851, 'NOR': 2239, 'CZE': 1418, 'GHA': 1801, 'COD': 1838,
    'BIH': 1759, 'CPV': 1810, 'JOR': 1245, 'CUW': 1521, 'HAI': 1197,
}
