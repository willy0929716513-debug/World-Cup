...
ALL_ELOS: dict[str, int] = {
    'ARG': 2389, 'BRA': 2180, 'FRA': 2363, 'ENG': 2106, 'ESP': 2019, 'GER': 1877,
    'POR': 1943, 'NED': 2131, 'URU': 1710, 'USA': 1902, 'MAR': 2153, 'BEL': 1902,
    'CRO': 1958, 'SUI': 2020, 'AUT': 1860, 'TUR': 1718, 'SCO': 1672, 'COL': 2095,
    'ECU': 1789, 'PAR': 1808, 'JPN': 1972, 'KOR': 1612, 'KSA': 1705, 'AUS': 1812,
    'IRN': 1811, 'QAT': 1556, 'IRQ': 1359, 'UZB': 1379, 'SEN': 1682, 'EGY': 1907,
    'CIV': 1867, 'ALG': 1839, 'RSA': 1689, 'TUN': 1347, 'MEX': 2270, 'CAN': 1842,
    'PAN': 1317, 'NZL': 1595,
    # New WC2026 teams
    'SWE': 1880, 'NOR': 2046, 'CZE': 1499, 'GHA': 1881, 'COD': 1823,
    'BIH': 1788, 'CPV': 1800, 'JOR': 1324, 'CUW': 1548, 'HAI': 1266,
}
