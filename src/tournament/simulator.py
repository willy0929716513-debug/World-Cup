...
ALL_ELOS: dict[str, int] = {
    'ARG': 2348, 'BRA': 2118, 'FRA': 2284, 'ENG': 2105, 'ESP': 1996, 'GER': 1926,
    'POR': 1870, 'NED': 2121, 'URU': 1728, 'USA': 1973, 'MAR': 2122, 'BEL': 1880,
    'CRO': 1801, 'SUI': 2003, 'AUT': 1893, 'TUR': 1647, 'SCO': 1689, 'COL': 2138,
    'ECU': 1755, 'PAR': 1808, 'JPN': 2000, 'KOR': 1644, 'KSA': 1693, 'AUS': 1812,
    'IRN': 1790, 'QAT': 1562, 'IRQ': 1442, 'UZB': 1447, 'SEN': 1666, 'EGY': 1923,
    'CIV': 1879, 'ALG': 1803, 'RSA': 1747, 'TUN': 1381, 'MEX': 2233, 'CAN': 1784,
    'PAN': 1350, 'NZL': 1622,
    # New WC2026 teams
    'SWE': 1862, 'NOR': 2047, 'CZE': 1522, 'GHA': 2006, 'COD': 1786,
    'BIH': 1779, 'CPV': 1817, 'JOR': 1368, 'CUW': 1533, 'HAI': 1310,
}
