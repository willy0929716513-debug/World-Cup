...
ALL_ELOS: dict[str, int] = {
    'ARG': 2417, 'BRA': 2244, 'FRA': 2436, 'ENG': 2142, 'ESP': 2051, 'GER': 1851,
    'POR': 2002, 'NED': 2124, 'URU': 1708, 'USA': 1941, 'MAR': 2196, 'BEL': 1904,
    'CRO': 1957, 'SUI': 2052, 'AUT': 1825, 'TUR': 1734, 'SCO': 1668, 'COL': 2093,
    'ECU': 1770, 'PAR': 1815, 'JPN': 1944, 'KOR': 1575, 'KSA': 1707, 'AUS': 1817,
    'IRN': 1813, 'QAT': 1568, 'IRQ': 1310, 'UZB': 1339, 'SEN': 1686, 'EGY': 1907,
    'CIV': 1824, 'ALG': 1837, 'RSA': 1646, 'TUN': 1320, 'MEX': 2307, 'CAN': 1864,
    'PAN': 1290, 'NZL': 1589,
    # New WC2026 teams
    'SWE': 1862, 'NOR': 2109, 'CZE': 1463, 'GHA': 1867, 'COD': 1811,
    'BIH': 1763, 'CPV': 1800, 'JOR': 1293, 'CUW': 1543, 'HAI': 1233,
}
