...
ALL_ELOS: dict[str, int] = {
    'ARG': 2170, 'BRA': 2022, 'FRA': 2169, 'ENG': 2151, 'ESP': 1907, 'GER': 2116,
    'POR': 1901, 'NED': 1993, 'URU': 1868, 'USA': 2230, 'MAR': 2087, 'BEL': 1880,
    'CRO': 1766, 'SUI': 1941, 'AUT': 2044, 'TUR': 1495, 'SCO': 1864, 'COL': 2056,
    'ECU': 1577, 'PAR': 1760, 'JPN': 1919, 'KOR': 1935, 'KSA': 1860, 'AUS': 1931,
    'IRN': 1788, 'QAT': 1748, 'IRQ': 1625, 'UZB': 1671, 'SEN': 1724, 'EGY': 1873,
    'CIV': 1731, 'ALG': 1718, 'RSA': 1623, 'TUN': 1620, 'MEX': 2215, 'CAN': 1944,
    'PAN': 1611, 'NZL': 1780,
    # New WC2026 teams
    'SWE': 2003, 'NOR': 2047, 'CZE': 1606, 'GHA': 1981, 'COD': 1887,
    'BIH': 1752, 'CPV': 1896, 'JOR': 1629, 'CUW': 1619, 'HAI': 1502,
}
