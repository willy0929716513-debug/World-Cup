...
ALL_ELOS: dict[str, int] = {
    'ARG': 2434, 'BRA': 2271, 'FRA': 2478, 'ENG': 2147, 'ESP': 2079, 'GER': 1837,
    'POR': 2063, 'NED': 2130, 'URU': 1714, 'USA': 1963, 'MAR': 2215, 'BEL': 1926,
    'CRO': 1915, 'SUI': 2088, 'AUT': 1787, 'TUR': 1748, 'SCO': 1668, 'COL': 2137,
    'ECU': 1758, 'PAR': 1832, 'JPN': 1939, 'KOR': 1551, 'KSA': 1713, 'AUS': 1841,
    'IRN': 1814, 'QAT': 1570, 'IRQ': 1284, 'UZB': 1318, 'SEN': 1663, 'EGY': 1897,
    'CIV': 1815, 'ALG': 1792, 'RSA': 1628, 'TUN': 1302, 'MEX': 2326, 'CAN': 1861,
    'PAN': 1272, 'NZL': 1589,
    # New WC2026 teams
    'SWE': 1853, 'NOR': 2135, 'CZE': 1439, 'GHA': 1826, 'COD': 1819,
    'BIH': 1758, 'CPV': 1804, 'JOR': 1269, 'CUW': 1531, 'HAI': 1215,
}
