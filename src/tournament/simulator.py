...
ALL_ELOS: dict[str, int] = {
    'ARG': 2433, 'BRA': 2239, 'FRA': 2472, 'ENG': 2176, 'ESP': 2095, 'GER': 1839,
    'POR': 2037, 'NED': 2127, 'URU': 1713, 'USA': 1938, 'MAR': 2214, 'BEL': 1942,
    'CRO': 1919, 'SUI': 2087, 'AUT': 1792, 'TUR': 1745, 'SCO': 1668, 'COL': 2127,
    'ECU': 1760, 'PAR': 1828, 'JPN': 1939, 'KOR': 1555, 'KSA': 1712, 'AUS': 1836,
    'IRN': 1813, 'QAT': 1569, 'IRQ': 1288, 'UZB': 1321, 'SEN': 1670, 'EGY': 1897,
    'CIV': 1816, 'ALG': 1798, 'RSA': 1631, 'TUN': 1305, 'MEX': 2294, 'CAN': 1860,
    'PAN': 1275, 'NZL': 1589,
    # New WC2026 teams
    'SWE': 1854, 'NOR': 2158, 'CZE': 1443, 'GHA': 1832, 'COD': 1817,
    'BIH': 1758, 'CPV': 1803, 'JOR': 1273, 'CUW': 1533, 'HAI': 1218,
}
