...
ALL_ELOS: dict[str, int] = {
    'ARG': 2243, 'BRA': 2018, 'FRA': 2178, 'ENG': 2154, 'ESP': 1961, 'GER': 2165,
    'POR': 1884, 'NED': 2067, 'URU': 1767, 'USA': 2152, 'MAR': 2054, 'BEL': 1855,
    'CRO': 1792, 'SUI': 1890, 'AUT': 1917, 'TUR': 1473, 'SCO': 1759, 'COL': 1977,
    'ECU': 1540, 'PAR': 1799, 'JPN': 2007, 'KOR': 1838, 'KSA': 1681, 'AUS': 1817,
    'IRN': 1775, 'QAT': 1680, 'IRQ': 1560, 'UZB': 1545, 'SEN': 1688, 'EGY': 1922,
    'CIV': 1825, 'ALG': 1752, 'RSA': 1605, 'TUN': 1482, 'MEX': 2116, 'CAN': 1872,
    'PAN': 1452, 'NZL': 1657,
    # New WC2026 teams
    'SWE': 1805, 'NOR': 2015, 'CZE': 1584, 'GHA': 1865, 'COD': 1833,
    'BIH': 1685, 'CPV': 1822, 'JOR': 1497, 'CUW': 1563, 'HAI': 1411,
}
